...
/**
 * GitHub and LinkedIn are the official brand marks, so they are filled paths.
 * Résumé and email are line glyphs drawn to sit at a similar weight at 14px.
 */
const ICONS: Record<LinkIconName, ReactElement> = {
  github: (
